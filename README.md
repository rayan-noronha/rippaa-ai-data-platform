...
```json
{
  ...
  "sources": [
    ...
    {
      "document_id": "3da22c57-2ca0-4ded-947e-ad51a938d11a",
      "filename": "claims_export_malformed_018.csv",
      "source_domain": "insurance",
      "relevance_score": 0.9385
    }
  ],
  "metadata": {
...
| [011](docs/adr/011-serving-layer.md) | Serving layer — FastAPI + Fargate + Prometheus | Accepted |
